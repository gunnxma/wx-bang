...
<title><?php echo C('site_name');?>-叶子微信科技后台管理系统</title>
<meta name="keywords" content="<?php echo C('site_name');?>-叶子微信科技后台管理系统" />
<meta name="description" content="<?php echo C('site_name');?>-叶子微信科技后台管理系统" />
  ...
  <tr>
	...
	<div class="top">
    	<a href="/" class="logo" title="首页">首页</a>
		 <div class="login">
			<li>您好：<b><?php echo (session('username')); ?></b> ，欢迎使用叶子微信！</li>	
			<li><a href="http://www.r2003.com">访问首页</a></li>
			<li><a href="<?php echo C('site_url');?>/">登陆前台</a></li>
			<li><a href="http://www.r2003.com">官方网址</a></li>
			<li><a href="http://bbs.r2003.com">官方论坛</a></li>
...
<p class="fr"> Copyright &copy; 2012-2013 叶子微信版权所有  </p>
</div></td>
  </tr>
</table>
</body>
