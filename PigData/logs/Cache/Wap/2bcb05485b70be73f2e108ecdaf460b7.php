  ...
  <div class="inner root" style="height: 468px;">
    <div id="card" class="card" style="background:url('<?php if($card["diybg"] != ''): echo ($card["diybg"]); else: echo ($card["bg"]); endif; ?>') no-repeat 0 0;-webkit-background-size:267px 159px;background-size:267px 159px;">
	  ...
	  <div id="card2" class="card" style="background:url('<?php if($card["diybg"] != ''): echo ($card["diybg"]); else: echo ($card["bg"]); endif; ?>') no-repeat 0 0;-webkit-background-size:267px 159px;background-size:267px 159px;display:none">
		  ...
		  <span style="color:<?php echo ($card["vipnamecolor"]); ?>">总店地址：<?php echo ($contact["address"]); ?></span>
		  </div>
    ...
    <ul class="round" style="display:block;clear:both">
	  ...
	  <a href="<?php echo U('Signscore/index',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id']));?>">会员卡签到</a></li>
	  <li class="intro" style="">
	  <a href="<?php echo U('Signscore/expend',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id']));?>">我的消费记录</a></li>
      <li class="intro" style="">
	  <a href="<?php echo U('Userinfo/index',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id']));?>">我的资料</a></li>
      <li class="intro" style="">
	  <a href="<?php echo U('Card/info',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id']));?>">会员卡说明</a></li>
      <li class="applicable" style="">
	  <a href="<?php echo U('Card/addr',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id']));?>">门店电话及地址</a></li>
