...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="cate4">
        ...
        <div style="display:none"><script src="./template44444444_files/stat.php" type="text/javascript" language="JavaScript"></script><script src="./template44444444_files/cnzz_core.php" charset="utf-8" type="text/javascript"></script><a href="http://www.cnzz.com/stat/website.php?web_id=5238979" target="_blank" title="站长统计"><img border="0" hspace="0" vspace="0" src="./template44444444_files/pic1.gif"></a></div>
