...
<p>自定义分：自定义文本、自定义图文、自定义语音。意思是，你在<?php echo C('site_name');?>写一个图文就少一个自定义图文〔vip0图文、文本、语音都有2000自定义，够挥霍了。〕</p>
</span></span></td>
                				<td>2000</td>
                				<td>3000</td>
                				<td>5000</td>
...
<p>先看自己适合什么套餐，然后充值相应人民币得到<?php echo C('site_name');?>币，用<?php echo C('site_name');?>币购买VIP套餐。（<?php echo C('site_name');?>币为<?php echo C('site_name');?>平台通用货币）</p>
</span></span></td>
...
<span>
<p><?php echo C('site_name');?>可以融合其他的接口，跟<?php echo C('site_name');?>接口一起使用。点击问号查看详情，论坛还有很多教程可以查看。</p>
</span></a></td>
                				<td class="error">&nbsp;</td>
                				<td class="checked ">&nbsp;</td>
                				<td class="checked ">&nbsp;</td>
