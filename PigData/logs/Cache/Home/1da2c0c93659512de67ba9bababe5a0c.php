...
<div class="top">
<div class="toplink">
<div class="welcome">欢迎使用微内蒙-多用户微信营销服务平台!</div>
        ...
        <ul id="topMenu">           
			 <li <?php if((ACTION_NAME == 'index') and (GROUP_NAME == 'Home')): ?>class="menuon"<?php endif; ?> ><a href="/" >首页</a></li>
                ...
                <li <?php if((GROUP_NAME) == "User"): ?>class="menuon"<?php endif; ?>><a href="<?php echo U('User/Index/index');?>">管理中心</a></li>
                  ...
                  <li <?php if((ACTION_NAME) == "fc"): ?>class="menuon"<?php endif; ?>><a href="http://veinm.com/" target="_blank">新闻中心</a></li>
                <li <?php if((ACTION_NAME) == "about"): ?>class="menuon"<?php endif; ?>><a href="http://veinm.com/" target="_blank">案例展示</a></li>
                <li <?php if((ACTION_NAME) == "price"): ?>class="menuon"<?php endif; ?>><a href="http://veinm.com/" target="_blank">关于我们</a></li>
                <li <?php if((ACTION_NAME) == "common"): ?>class="menuon"<?php endif; ?>><a href="http://veinm.com/" target="_blank">联系我们</a></li> 
               <li <?php if((ACTION_NAME) == "help"): ?>class="menuon"<?php endif; ?>><a href="http://veinm.com/" target="_blank">帮助中心</a></li>				
            </ul>
        </div>
        </div>
    </div>
...
<div class="foot">
<div class="foot_page">
● <a href="<?php echo C('site_url');?>">微内蒙-微信运营平台</a><br/>
● 帮助您快速搭建属于自己的营销平台,构建自己的客户关系维护系统。
</div>
<div id="copyright">
	Power by <?php echo C('site_name');?> (c) 2013 微内蒙 版权所有<br/>
	售前咨询QQ：<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=505581766&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:505581766:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>
	技术支持QQ：<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=505581766&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:505581766:41" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>
</div>
    </div>
</div>
