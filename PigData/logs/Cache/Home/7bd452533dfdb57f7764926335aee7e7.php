...
<title>功能介绍－微信 微信帮手 微信公众账号</title>
<meta name="keywords" content="微信 微信帮手 微信公众账号 微信公众平台 微信公众账号开发 微信二次开发 微信接口开发 微信托管服务 微信营销 微信公众平台接口开发"/>
    ...
    <div class="logo">
	 ...
	 <li <?php if((ACTION_NAME == 'index') and (GROUP_NAME == 'Home')): ?>class="menuon"<?php endif; ?> ><a href="/" >首页</a></li>
                ...
                <li <?php if((GROUP_NAME) == "User"): ?>class="menuon"<?php endif; ?>><a href="<?php echo U('User/Index/index');?>">管理中心</a></li>
                  ...
                  <li <?php if((ACTION_NAME) == "fc"): ?>class="menuon"<?php endif; ?>><a href="http://waixin.waiwaili.com/news" target="_blank">新闻中心</a></li>
                <li <?php if((ACTION_NAME) == "about"): ?>class="menuon"<?php endif; ?>><a href="http://waixin.waiwaili.com/case" target="_blank">案例展示</a></li>
                <li <?php if((ACTION_NAME) == "price"): ?>class="menuon"<?php endif; ?>><a href="http://waixin.waiwaili.com/about" target="_blank">关于我们</a></li>
                <li <?php if((ACTION_NAME) == "common"): ?>class="menuon"<?php endif; ?>><a href="http://waixin.waiwaili.com/contact" target="_blank">联系我们</a></li> 
               <li <?php if((ACTION_NAME) == "help"): ?>class="menuon"<?php endif; ?>><a href="http://waixin.waiwaili.com/75.htm" target="_blank">帮助中心</a></li>		
